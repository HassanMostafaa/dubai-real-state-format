    ...
    <footer className="bg-secondary text-white">
      <div className="container py-12">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          <div>
            <h3 className="text-2xl font-display font-bold text-primary mb-4">Dubai Estates</h3>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><a href="#properties" className="text-gray-400 hover:text-primary">Properties</a></li>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li><a href="#" className="text-gray-400 hover:text-primary">Apartments</a></li>
              <li><a href="#" className="text-gray-400 hover:text-primary">Villas</a></li>
              <li><a href="#" className="text-gray-400 hover:text-primary">Penthouses</a></li>
              <li><a href="#" className="text-gray-400 hover:text-primary">Off-Plan</a></li>
            </ul>
          </div>
        ...
        <div className="border-t border-gray-800 mt-12 pt-8">
          <p className="text-center text-gray-400">
            &copy; {currentYear} Dubai Estates. All rights reserved.
          </p>
        </div>
      </div>
    </footer>
